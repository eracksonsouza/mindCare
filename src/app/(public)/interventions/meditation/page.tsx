...
export default function MeditationPage() {
  ...
  const currentMeditation =
    meditations.find((m) => m.duration === selectedDuration) || meditations[0];
  ...
  useEffect(() => {
    ...
    const stepDuration =
      (selectedDuration * 60) / currentMeditation.steps.length;
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 sm:p-12">
          ...
          <div className="mt-8 bg-purple-50 dark:bg-purple-900/30 rounded-2xl p-4">
            <p className="text-sm text-gray-700 dark:text-gray-300">
              <strong>💡 Dica:</strong> Não se preocupe se sua mente vagar. É
              completamente normal! Apenas reconheça gentilmente e traga sua
              atenção de volta ao momento presente.
            </p>
          </div>
        </div>
      </div>
