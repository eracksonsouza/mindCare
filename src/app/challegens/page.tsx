...
export default function ChallengesPage() {
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-indigo-900 dark:to-purple-900 font-sans p-4 sm:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold bg-linear-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent mb-4 flex items-center justify-center gap-2">
            <Target className="w-10 h-10 text-indigo-600 dark:text-indigo-400" />
            Desafios de Bem-Estar
          </h1>
          <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl mx-auto">
            Desafios diários para desenvolver hábitos saudáveis e cuidar da sua
            saúde mental
          </p>
        </div>
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 sm:p-12 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-md mx-auto">
            Estamos preparando desafios incríveis para você praticar autocuidado
            de forma divertida e consistente.
          </p>
          ...
          <Link
            href="/"
            className="inline-flex px-8 py-4 rounded-full bg-linear-to-r from-indigo-600 to-purple-600 text-white font-semibold hover:shadow-lg hover:scale-105 transition-all"
          >
            Voltar ao Início
          </Link>
        </div>
